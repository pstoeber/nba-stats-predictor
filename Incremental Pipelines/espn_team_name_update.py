...
def main():
    ...
    logging.info('Updating ESPN team names {}'.format(str(datetime.datetime.now())))
    ...
    logging.info('ESPN team names update completed successfully {}'.format(str(datetime.datetime.now())))
